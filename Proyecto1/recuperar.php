...
<body>
    <div class="form-container">
        <form action="login.php" method="POST">
            ...
            <p class="description">Ingresa una nueva contraseña<br>y confirmala.</p>
            <div class="input-container">
    <input type="password" placeholder="Contraseña" name="contrasena" id="password">
    <img src="icons/light-lock.svg" class="icon-left" id="lockIcon1"> <!-- Cambiado -->
    <img src="icons/light-eye.svg" class="icon-right" id="togglePassword">
</div>
<div class="input-container">
    <input type="password" placeholder="Confirmar contraseña" name="contrasenaconf" id="passwordConfirm">
    <img src="icons/light-lock.svg" class="icon-left" id="lockIcon2"> <!-- Cambiado -->
    <img src="icons/light-eye.svg" class="icon-right" id="togglePasswordConfirm">
</div>
